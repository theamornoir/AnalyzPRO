...
const (
	...
	// сравниваются между собой и показывают прогресс в «Моём профиле».
	MsgReportProgressNote = "🔁 Повторные отчёты автоматически сравниваются с предыдущими - динамику (что улучшилось, что подтянуть) видно в «Моём профиле». Откройте 📊 Здоровье → 📊 Мой профиль."
	...
	MsgDemoRepeatBanner = "🧪 ДЕМО: ПОВТОРНЫЙ отчёт - сравнение с предыдущим. Это результат второго прохода: отчёт строится не «с нуля», а с блоком сравнения (что улучшилось, что улучшить). В обычном режиме сравнение происходит автоматически и видно в «Моём профиле»."
