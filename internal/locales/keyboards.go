...
const (
	...
	MsgDemoRepeatBanner = "🧪 ДЕМО: ПОВТОРНЫЙ отчёт - сравнение с предыдущим. Это результат второго прохода: отчёт строится не «с нуля», а с блоком сравнения (что улучшилось, что улучшить). В обычном режиме сравнение происходит автоматически и видно в «Сводке здоровья»."
