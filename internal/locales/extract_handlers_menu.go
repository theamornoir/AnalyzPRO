...
const (
	...
	// версия: без звёздочек, без HTML-тегов, обычный текст с отступами).
	...
	MsgPremiumSubscription = "💎 Премиум-подписка\n\n" +
		...
		"499 ₽\n\n" +
		"📌 3 месяца\n" +
		"Всё, что в тарифе «1 месяц».\n" +
		"Экономия 15% — выгодно для долгосрочного контроля.\n\n" +
		"1275 ₽\n\n" +
		"📌 1 год\n" +
		"Максимальная экономия — скидка 30%.\n" +
		"Мониторинг курсов и полный контроль показателей.\n\n" +
		"1799 ₽\n\n" +
