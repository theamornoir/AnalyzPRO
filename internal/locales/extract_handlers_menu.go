...
const (
	...
	// MsgPremiumSubscription - сводный экран тарифов Premium (без звёздочек,
	// форматирование через HTML-тег <b>). Отправляется с ParseMode HTML.
	MsgPremiumSubscription = "💎 Премиум-подписка\n\n" +
		"📌 <b>1 месяц</b>\n" +
		"499 ₽\n" +
		"• Безлимитная расшифровка анализов и биосанов\n" +
		"• Полная история и графики в личном профиле\n" +
		"• Расширенная диагностика с опросниками\n\n" +
		"📌 <b>3 месяца</b>\n" +
		"1275 ₽\n" +
		"• Экономия 15%\n" +
		"• Все преимущества тарифа «1 месяц»\n" +
		"• Долгосрочное отслеживание динамики\n\n" +
		"📌 <b>1 год</b>\n" +
		"1799 ₽\n" +
		"• Экономия 30%\n" +
		"• Все преимущества тарифа «3 месяца»\n" +
		"• Мониторинг курсов и ключевых показателей"
