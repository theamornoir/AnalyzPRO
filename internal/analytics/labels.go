...
var callbackLabels = map[string]string{
	...
	"section_diag_extended":          "Выбрал Общую оценку здоровья",
	...
	"section_diag_extended_demo":     "Открыл Демо: Общую оценку здоровья",
	...
	"section_test_notify":            "Открыл Тест уведомлений",
	"test_notify_reminder":           "Тест: напоминание",
	"test_notify_motivation":         "Тест: мотивация",
	"test_notify_feature":            "Тест: фича",
	"test_notify_back":               "Назад (тест уведомлений)",
...
var buttonLabels = map[string]string{
	...
	locales.BtnExtendedAnalysis: "Выбрал Общую оценку здоровья",
