...
func handleTextUpload(
	...
	// Результат ИИ может быть длиннее лимита Telegram (4096 символов) -
	// отправляем с дроблением по 4000, иначе сообщение не дойдёт, хотя
	// бот уже напишет «готово» и сохранит результат в профиль.
