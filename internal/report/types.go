...
type Category struct {
	...
	Icon        string      `json:"icon"`        // Добавлено
	Color       string      `json:"color"`       // Добавлено
}
...
type Indicator struct {
	...
	Role           string `json:"role"`       // Добавлено
	ShortDesc      string `json:"short_desc"` // Добавлено
	FullDesc       string `json:"full_desc"`  // Добавлено
	Function       string `json:"function"`   // Добавлено
}
